...
function hintBrowser(csrf_token, candidate_id) {
    ...
    modal.style.cssText = 'z-index: 1; -webkit-clip-path: polygon(0 0, 100% 0%, 100% 100%, 0% 100%);clip-path: polygon(0 0, 100% 0%, 100% 100%, 0% 100%);'
...
function removeHint() {
    ...
    modal.style.cssText = 'z-index: -5; -webkit-clip-path: polygon(calc(50% - 0em) calc(50% - 0em), calc(50% + 0em) calc(50% - 0em), calc(50% + 0em) calc(50% + 0em), calc(50% - 0em) calc( 50% + 0em));clip-path: polygon(calc(50% - 0em) calc(50% - 0em), calc(50% + 0em) calc(50% - 0em), calc(50% + 0em) calc(50% + 0em), calc(50% - 0em) calc( 50% + 0em));'
